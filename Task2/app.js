...
app.get('/battle',function(req,res){//battle & return us result of it and pre-hashed string
    ...
    console.log("gamerWord="+gamerWord);
    var gamerId=names.indexOf(gamerWord);
    var gamerAnswer=rulesArray.indexOf(gamerId);
    var roboAnswer=rulesArray.indexOf(compRes);
    var bResult=battle(roboAnswer,gamerAnswer);
    var winner=resultMass[bResult+1];
    var result={winner:winner,phString:prehashString,compWord:names[compRes]};
    res.send(result);
})
